window.onload = function () {
    ...
    function beep() {
        ...
        snd.play();
        document.getElementById("metro").style.transform = "scaleX(" + metro + ")"
        metro = metro * -1;
    }

    metronomo.start = function () {
        if (ativo) return;
        ativo = true;
        counterms = setInterval(beep, getTime());
    };
    ...
    ['start', 'stop', 'reset'].forEach(function (tipo) {
        ...
        input.addEventListener('click', metronomo[tipo]);
    });
};